/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 39057136f655287c0b2798629228d19b)
...
declare namespace Cloudflare {
	...
	interface Env {
		NEXTJS_ENV: string;
		NEXT_PUBLIC_ACCESS_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_ACCESS_PASSWORD">> {}
}
